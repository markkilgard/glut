...
\rndx{glutWarpPointer} warps the pointer's location.
...
\rndx{glutBitmapLength} returns the length of a bitmap font string.
...
\rndx{glutStrokeLength} returns the length of a stroke font string.
