...
/* Disable VC 7.1 warning: 'type cast' : from data pointer 'void *'
   to function pointer 'GLUTblahFCB' */
#if defined(_MSC_VER)
...
/* Disable VC 7.1 warning: 'type cast' : from function pointer
   'GLUTblahFCB' to data pointer 'void *' */
#if defined(_MSC_VER)
